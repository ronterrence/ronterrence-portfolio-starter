  ...
  return (
    <section className="hero" id="top">
      ...
      <div className="hero-actions">
        ...
        <a className="button secondary" href="https://github.com/ronterrence" target="_blank" rel="noreferrer">
    ...
    <article className="project-card">
      ...
      <div className="project-body">
        <div className="project-meta">
          ...
          <span>{project.archived ? 'Archived' : project.status}</span>
        ...
        <div className="project-links">
          {project.repositories.map((repository) => (
            <a key={repository.url} href={repository.url} target="_blank" rel="noreferrer">
              <GitHubIcon size={16} /> {repository.label}
            </a>
          ))}
        ...
        {project.updatedAt && (
          <p className="project-updated">
            GitHub updated <time dateTime={project.updatedAt}>{new Intl.DateTimeFormat('en', { month: 'short', year: 'numeric' }).format(new Date(project.updatedAt))}</time>
          </p>
        )}
      </div>
    </article>
...
function Projects() {
  ...
  const filteredProjects = useMemo(() => {
    return projects.filter((project) => {
      const searchable = `${project.name} ${project.tagline} ${project.category} ${project.tags.join(' ')} ${project.description} ${project.languages?.join(' ') || ''}`.toLowerCase();
  ...
  return (
    <section className="section contact" id="contact">
      ...
      <div className="contact-links">
        ...
        <a href="https://github.com/ronterrence" target="_blank" rel="noreferrer"><GitHubIcon size={18} /> GitHub</a>
      </div>
    </section>
  );
}
